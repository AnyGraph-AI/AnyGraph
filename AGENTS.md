...
13. **Neo4j integration test timeouts: minimum 60s.** Tests that hit Neo4j and take >5s in isolation need `{ timeout: 60_000 }`. Full-suite DB contention (3000+ parallel tests) multiplies query time unpredictably. "Passes in isolation" ≠ "timeout is safe." Default to 60s for any test doing real graph queries. (SCAR-013, 2026-03-26)
