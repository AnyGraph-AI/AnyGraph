...
(Includes edge project-tag normalization, plan evidence recomputation, registry reconciliation/verification, edge-tag taxonomy verification, plus integrity snapshot/verification.)
